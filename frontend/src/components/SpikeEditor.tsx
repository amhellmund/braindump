    ...
    <div className="spike-editor">
      ...
      <div className="editor-toolbar">
        ...
        <div className="editor-actions">
          ...
          <button className="btn-save" disabled={!isDirty} onClick={() => handleSave(false)}>
            Save
          </button>
          <button className="btn-save-update" disabled={!isDirty} onClick={() => handleSave(true)}>
            Save + Update
          </button>
